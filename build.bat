...
cl %CommonCompilerFlags% %src%\win_Kalm2D.cpp -Fm /link %CommonLinkerFlags% opengl32.lib glfw3dll.lib -out:Kalm2D.exe
REM lib -nologo win_Kalm2D.obj /DEF
cl %CommonCompilerFlags% %src%\kGame2D.cpp -Fm /LD /DLL /link %CommonLinkerFlags% -EXPORT:GetGameAPI -out:Game64.dll
